...
In M1 the whole engine is shadow — `ShadowGuard(github=None)` — so the engine never mutates
...
promoting a partition to live (M2 makes promotion per-partition).
"""
