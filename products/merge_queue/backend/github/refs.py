...
def master_head(repo: str, *, integration_id: int) -> str:
    ...
    TODO(M4): the integration lookup is wired but the default-branch resolution and any
    caching belong with the CI/affected-target work; M1 callers pass an explicit sha in
    ...
    raise NotImplementedError("master_head resolution lands with the GitHub adapter wiring (M1 task 10)")
