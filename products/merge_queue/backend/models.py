"""Stampede data model (locked — `docs/stampede-facade-and-data-model.md` Part A).
...
class QueueEvent(models.Model):
    ...
    The single source for `engineering_analytics` emission (RFC §13), the break-glass
    audit (RFC §10), and Cowboy's shadow-decision records (RFC §4.2).
    """
