...
from posthog.temporal.data_imports.cdc.broken import mark_cdc_broken
...
def _mocked_boundaries():
    ...
    with (
        patch("products.data_warehouse.backend.data_load.service.pause_cdc_extraction_schedule") as mock_pause,
